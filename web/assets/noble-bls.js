var __horizon_bls__ = (() => {
  ...
  // bls-entry.mjs
  var bls_entry_exports = {};
  __export(bls_entry_exports, {
    KONTOR_BLS_DST: () => KONTOR_BLS_DST,
    deriveBlsKey: () => deriveBlsKey,
    deriveMasterSK: () => deriveMasterSK,
    getPublicKey: () => getPublicKey,
    schnorrBindingHash: () => schnorrBindingHash,
    sign: () => sign,
    signBlsBinding: () => signBlsBinding
  });
  ...
  // node_modules/@unspendablelabs/kontor-portal-client/dist/postcard.js
  var KONTOR_BLS_DST = "BLS_SIG_BLS12381G1_XMD:SHA-256_SSWU_RO_NUL_";
  var KONTOR_OP_PREFIX = new TextEncoder().encode("KONTOR-OP-V1");

  // node_modules/@unspendablelabs/kontor-portal-client/dist/bls-primitives.js
  var BLS_ORDER = BigInt("0x73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001");
  ...
  return __toCommonJS(bls_entry_exports);
})();
