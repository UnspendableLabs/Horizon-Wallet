...
class BitcoinDecodedTxModel {
  ...
  factory BitcoinDecodedTxModel.fromJson(Map<String, dynamic> json) =>
      _$BitcoinDecodedTxModelFromJson(json);

  Map<String, dynamic> toJson() => _$BitcoinDecodedTxModelToJson(this);

  BitcoinDecodedTx toDomain() => BitcoinDecodedTx(
        txid: txid,
        hash: hash,
        version: version,
        size: size,
