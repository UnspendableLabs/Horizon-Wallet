...
BitcoinDecodedTxModel _$BitcoinDecodedTxModelFromJson(
        Map<String, dynamic> json) =>
    BitcoinDecodedTxModel(
...
Map<String, dynamic> _$BitcoinDecodedTxModelToJson(
        BitcoinDecodedTxModel instance) =>
    <String, dynamic>{
      'txid': instance.txid,
      'hash': instance.hash,
