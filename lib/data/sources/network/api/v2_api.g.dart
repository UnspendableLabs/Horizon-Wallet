...
AssetVerbose _$AssetVerboseFromJson(Map<String, dynamic> json) => AssetVerbose(
      ...
      divisible: json['divisible'] as bool?,
      locked: json['locked'] as bool?,
      descriptionLocked: json['description_locked'] as bool?,
      issuer: json['issuer'] as String?,
...
Map<String, dynamic> _$AssetVerboseToJson(AssetVerbose instance) =>
    <String, dynamic>{
      ...
      'divisible': instance.divisible,
      'locked': instance.locked,
      'description_locked': instance.descriptionLocked,
...
class _V2Api implements V2Api {
  ...
  Future<Response<List<dynamic>>> getEventsByAddressesVerboseOpaque(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<Response<List<dynamic>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _value = Response<List<dynamic>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
  ...
  Future<Response<ComposeMoveToUtxoResponseModel>> composeMoveToUtxo(
    ...
    final _value = Response<ComposeMoveToUtxoResponseModel>.fromJson(
      _result.data!,
      (json) =>
          ComposeMoveToUtxoResponseModel.fromJson(json as Map<String, dynamic>),
    );
    return _value;
  }
