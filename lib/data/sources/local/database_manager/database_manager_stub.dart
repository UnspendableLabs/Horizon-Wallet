...
class DatabaseManagerStub implements DatabaseManager {
  ...
  Future<void> deleteDatabase() async {
    throw UnimplementedError('[DatabaseManagerStub] deleteDatabase() is not supported on this platform.');
  }

  @override
  dynamic get database {
    throw UnimplementedError('[DatabaseManagerStub] database getter is not supported on this platform.');
  }
}
