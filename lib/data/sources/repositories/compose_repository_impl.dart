...
class ComposeRepositoryImpl extends ComposeRepository {
  ...
  Future<compose_issuance.ComposeIssuance> composeIssuance(String sourceAddress, String name, double quantity,
    ...
    return compose_issuance.ComposeIssuance(rawtransaction: response.result!.rawtransaction, params: compose_issuance.ComposeIssuanceParams(source: sourceAddress, asset: name, quantity: quantity, divisible: divisible, lock: lock, description: description, transferDestination: transferDestination), name: name);
  }
}
