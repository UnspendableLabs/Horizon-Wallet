...
class AddressTxRepositoryImpl extends AddressTxRepository {
  ...
  @override
  TaskEither<NetworkError, List<send_entity.Send>> getSendsByAddress(
  ...
  @override
  TaskEither<NetworkError, List<issuance_entity.Issuance>>
      getIssuancesByAddress(String address, HttpConfig httpConfig) {
    return handleNetworkCall(() async {
  ...
  @override
  TaskEither<NetworkError, List<transaction_entity.Transaction>>
      getTransactionsByAddress(String address, HttpConfig httpConfig) {
    return handleNetworkCall(() async {
