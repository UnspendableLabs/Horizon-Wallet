...
class WalletServiceNative implements WalletService {
  ...
  Future<entity.Wallet> deriveRootFreewallet(
    ...
    throw UnimplementedError("[WalletServiceNative] deriveRootFreewallet not implemented");
  }

  @override
  Future<entity.Wallet> deriveRootCounterwallet(
      String mnemonic, String password) async {
    throw UnimplementedError("[WalletServiceNative] deriveRootCounterwallet not implemented");
  }
  ...
  Future<entity.Wallet> fromPrivateKey(
    ...
    throw UnimplementedError("[WalletServiceNative] fromPrivateKey not implemented");
  }

  @override
  Future<entity.Wallet> fromBase58(String privateKey, String password) async {
    throw UnimplementedError("[WalletServiceNative] fromBase58 not implemented");
  }
}
...
WalletService createWalletServiceImpl({
  ...
  required Config config,
    ...
    WalletServiceNative(encryptionService, config);
