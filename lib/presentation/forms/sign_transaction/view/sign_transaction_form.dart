...
import 'package:horizon/presentation/forms/sign_transaction/bloc/sign_transaction_bloc.dart';
import 'package:horizon/presentation/forms/sign_transaction/bloc/sign_transaction_state.dart';
import 'package:horizon/presentation/forms/sign_transaction/bloc/sign_transaction_event.dart';

// example import

class SignTransactionForm extends StatefulWidget {
  ...
  @override
  State<SignTransactionForm> createState() => _SignTransactionFormState();
}

class _SignTransactionFormState extends State<SignTransactionForm> {
  bool _isExpanded = false;

  @override
  void initState() {
    super.initState();
    context.read<SignTransactionBloc>().add(FetchFormEvent());
  }
  ...
  Widget build(BuildContext context) {
    return BlocListener<SignTransactionBloc, SignTransactionState>(
      ...
      child:
          BlocBuilder<SignTransactionBloc, SignTransactionState>(builder: (context, state) {
              ...
              children: [
                ElevatedButton(
                  onPressed: state.submissionStatus.isInProgressOrSuccess
                      ? null
                      : () =>
                          context.read<SignTransactionBloc>().add(SignTransactionSubmitted()),
