...
import 'package:horizon/presentation/forms/send_form/send_form_bloc.dart';
...
class SendFormView extends StatefulWidget {
  ...
  @override
  State<SendFormView> createState() => _SendFormViewState();
}

class _SendFormViewState extends State<SendFormView> {
  ...
  void _handleOnFormStepNext(BuildContext context,
    ...
    context.read<SendFormBloc>().add(SendTransactionComposed(
  ...
  void _handleFeeOptionSelected(BuildContext context, FeeOption feeOption) {
    context.read<SendFormBloc>().add(FeeOptionSelected(feeOption: feeOption));
  }

  void _handleDependenciesRequested(BuildContext context) {
    context.read<SendFormBloc>().add(SendDependenciesRequested(
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<SendFormBloc,
