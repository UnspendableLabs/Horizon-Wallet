...
part of 'compose_detach_utxo_state.dart';
...
/// @nodoc
mixin _$ComposeDetachUtxoState {
...
/// @nodoc
abstract class $ComposeDetachUtxoStateCopyWith<$Res> {
  factory $ComposeDetachUtxoStateCopyWith(ComposeDetachUtxoState value,
          $Res Function(ComposeDetachUtxoState) then) =
      _$ComposeDetachUtxoStateCopyWithImpl<$Res, ComposeDetachUtxoState>;
  @useResult
  $Res call(
      {FeeState feeState,
...
/// @nodoc
class _$ComposeDetachUtxoStateCopyWithImpl<$Res,
        $Val extends ComposeDetachUtxoState>
    implements $ComposeDetachUtxoStateCopyWith<$Res> {
  _$ComposeDetachUtxoStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ComposeDetachUtxoStateImplCopyWith<$Res>
    implements $ComposeDetachUtxoStateCopyWith<$Res> {
  factory _$$ComposeDetachUtxoStateImplCopyWith(
          _$ComposeDetachUtxoStateImpl value,
          $Res Function(_$ComposeDetachUtxoStateImpl) then) =
      __$$ComposeDetachUtxoStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {FeeState feeState,
...
/// @nodoc
class __$$ComposeDetachUtxoStateImplCopyWithImpl<$Res>
    extends _$ComposeDetachUtxoStateCopyWithImpl<$Res,
        _$ComposeDetachUtxoStateImpl>
    implements _$$ComposeDetachUtxoStateImplCopyWith<$Res> {
  __$$ComposeDetachUtxoStateImplCopyWithImpl(
      _$ComposeDetachUtxoStateImpl _value,
  ...
  $Res call({
    ...
    return _then(_$ComposeDetachUtxoStateImpl(
      feeState: null == feeState
          ? _value.feeState
          : feeState // ignore: cast_nullable_to_non_nullable
              as FeeState,
...
class _$ComposeDetachUtxoStateImpl extends _ComposeDetachUtxoState {
  const _$ComposeDetachUtxoStateImpl(
...
// Inherited properties
  ...
  @override
  String toString() {
    return 'ComposeDetachUtxoState(feeState: $feeState, balancesState: $balancesState, feeOption: $feeOption, submitState: $submitState)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ComposeDetachUtxoStateImpl &&
  ...
  _$$ComposeDetachUtxoStateImplCopyWith<_$ComposeDetachUtxoStateImpl>
      get copyWith => __$$ComposeDetachUtxoStateImplCopyWithImpl<
          _$ComposeDetachUtxoStateImpl>(this, _$identity);
}

abstract class _ComposeDetachUtxoState extends ComposeDetachUtxoState {
  const factory _ComposeDetachUtxoState(
