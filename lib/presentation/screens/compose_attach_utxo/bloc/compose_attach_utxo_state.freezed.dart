...
// Specific properties
  ...
  @override
  String toString() {
    return 'ComposeAttachUtxoState(feeState: $feeState, balancesState: $balancesState, feeOption: $feeOption, submitState: $submitState, assetState: $assetState)';
  }
...
abstract class _ComposeAttachUtxoState extends ComposeAttachUtxoState {
  const factory _ComposeAttachUtxoState(
      ...
      required final AssetState assetState}) = _$ComposeAttachUtxoStateImpl;
