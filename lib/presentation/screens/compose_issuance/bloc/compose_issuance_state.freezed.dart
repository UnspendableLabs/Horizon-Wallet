...
class _$ComposeIssuanceStateImpl extends _ComposeIssuanceState {
...
// Specific properties
  ...
  @override
  String toString() {
    return 'ComposeIssuanceState(feeState: $feeState, balancesState: $balancesState, feeOption: $feeOption, submitState: $submitState, assetName: $assetName, assetDescription: $assetDescription, quantity: $quantity)';
  }
...
abstract class _ComposeIssuanceState extends ComposeIssuanceState {
