...
// Inherited properties
  ...
  @override
  String toString() {
    return 'ComposeDividendState(feeState: $feeState, balancesState: $balancesState, feeOption: $feeOption, submitState: $submitState)';
  }
...
abstract class _ComposeDividendState extends ComposeDividendState {
  const factory _ComposeDividendState(
      ...
      required final SubmitState submitState}) = _$ComposeDividendStateImpl;
