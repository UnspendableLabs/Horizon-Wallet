...
enum ImportFormat {
  segwit("Segwit", "BIP84,P2WPKH,Bech32"),
...
class _OnboardingImportPageState extends State<OnboardingImportPage_> {
  ...
  final TextEditingController _importFormat = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return   
    BlocBuilder<OnboardingImportBloc, OnboardingImportState>(
              ...
              child: Column(
                ...
                children: [
                  Expanded(
                    ...
                    TextField(
                      ...
                      onChanged: (value) {
                        context.read<OnboardingImportBloc>().add(DeriveAddress(
                            mnemonic: value,
                            importFormat: ImportFormat.segwit.name)); // TODO: get from dropdown
                      },
                    ...
                    Text(state is Success ? state.address : "adfasdf"),
