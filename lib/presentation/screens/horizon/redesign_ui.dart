...
class HorizonPasswordPrompt extends StatefulWidget {
  ...
  final String buttonText;
  final String title;
  /// Optional helper text shown below the title (e.g. export password guidance).
  final String? subtitle;
  /// When non-null, replaces [subtitle] for richer layout.
...
class _HorizonPasswordPromptState extends State<HorizonPasswordPrompt> {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final isDarkMode = theme.brightness == Brightness.dark;
    final baseSubtitleColor = theme.textTheme.bodySmall?.color;
    final subtitleMutedColor = baseSubtitleColor?.withValues(
      alpha: (baseSubtitleColor.a * 0.85).clamp(0.0, 1.0),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final thumbPosition =
            ((_value - widget.min) / (widget.max - widget.min)) * thumbTravel;
            ...
            children: [
              GestureDetector(
                ...
                onTapDown: (details) {
                  ...
                  final tapPosition = (position.dx - widget.thumbSize / 2)
                      .clamp(0, thumbTravel);
                    ...
                    Positioned(
                      ...
                      child: ClipRRect(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            gradient:
                                widget.trackColor == null ? gradient : null,
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onHorizontalDragUpdate: (details) {
                    ...
                    final position =
                        renderBox.globalToLocal(details.globalPosition);
                    final dragPosition = (position.dx - widget.thumbSize / 2)
                        .clamp(0, thumbTravel);
                    final double rawValue = widget.min +
