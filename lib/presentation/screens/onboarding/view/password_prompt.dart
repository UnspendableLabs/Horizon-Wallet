      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: isDarkMode ? mainTextWhite : mainTextBlack),
            textAlign: TextAlign.center,
          ),
          const SizedBox(height: 8),
          Container(
            constraints: BoxConstraints(maxWidth: isSmallScreen ? screenSize.width : screenSize.width / 2),
            child: const Text(
          ...
          Center(
            child: SizedBox(
              width: isSmallScreen ? screenSize.width : screenSize.width / 3,
              child: TextFormField(
          ...
          Container(
            ...
            child: Center(
              child: SizedBox(
                ...
                child: TextFormField(
                  validator: (value) =>
                      validatePasswordConfirmation(passwordController.text, passwordConfirmationController.text),
                  onFieldSubmitted: (_) {
                    if (formKey.currentState!.validate()) {
                      widget.onPressedContinue(passwordController.text);
                    }
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      icon: Icon(
                        _isPasswordConfirmationObscured ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                      ),
                      onPressed: () {
                        setState(() {
          ...
          widget.optionalErrorWiget != null ? widget.optionalErrorWiget! : const SizedBox.shrink(),
          const Spacer(),
          BackContinueButtons(
