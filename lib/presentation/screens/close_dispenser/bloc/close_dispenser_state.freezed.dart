...
// Inherited properties
  ...
  @override
  String toString() {
    return 'CloseDispenserState(feeState: $feeState, balancesState: $balancesState, feeOption: $feeOption, submitState: $submitState)';
  }
...
abstract class _CloseDispenserState extends CloseDispenserState {
  const factory _CloseDispenserState(
      ...
      required final SubmitState submitState}) = _$CloseDispenserStateImpl;
