...
import 'package:horizon/data/services/hd_wallet_service_impl.dart';
...
void setup() {
  ...
  injector.registerSingleton<HDWalletService>(HDWalletServiceImpl(GetIt.I.get<EncryptionService>()));
