...
class GetFeeEstimatesEsploraUseCase
    implements
        UseCaseTE<Map<String, double>, GetFeeEstimatesEsploraParams, String> {
  ...
  @override
  TaskEither<String, Map<String, double>> call(
      GetFeeEstimatesEsploraParams params) {
    final task = handleNetworkCall(() async {
      return await _bitcoinRepository.getFeeEstimates(
