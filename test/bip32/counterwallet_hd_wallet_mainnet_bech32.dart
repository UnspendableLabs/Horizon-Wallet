...
void main() async {
  ...
  group('Test Bip44 mainnet bech32', () {
    ...
    test('createBip32AddressFromSeed btc cointype', () {
      ...
      Address address = counterwalletHDWalletUtil.createBip32AddressFromSeed(
          mnemonic, 0, AddressType.bech32);
