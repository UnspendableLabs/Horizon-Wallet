  ...
  group('createBip32PubKeyPrivateKeyFromSeed testnet', () {
    ...
    test('generates an expected public key and private key for index 0', () {
      ...
      KeyPair keyPair = bip32.createPublicPrivateKeyPairForPath(
          Bip32KeyPairArgs(seedIntList: seedIntList, path: 'm/0\'/0/0', network: NetworkEnum.testnet));
    ...
    test('generates an expected public key and private key for index 12', () {
      ...
      Uint8List seedIntList = bip39.mnemonicToSeed(mnemonic);
      KeyPair keyPair = bip32.createPublicPrivateKeyPairForPath(
          Bip32KeyPairArgs(seedIntList: seedIntList, path: 'm/0\'/0/12', network: NetworkEnum.testnet));
    ...
    test('generates an expected public key and private key for index 2', () {
      ...
      Uint8List seedIntList = bip39.mnemonicToSeed(mnemonic);
      KeyPair keyPair = bip32.createPublicPrivateKeyPairForPath(
          Bip32KeyPairArgs(seedIntList: seedIntList, path: 'm/0\'/0/2', network: NetworkEnum.testnet));
