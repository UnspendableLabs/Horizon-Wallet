...
class ImportedAddresses extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  ImportedAddresses createAlias(String alias) {
    return ImportedAddresses(attachedDatabase, alias);
  }
}

class WalletConfigs extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  WalletConfigs(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> uuid = GeneratedColumn<String>(
      'uuid', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: true,
  ...
  @override
  WalletConfigs createAlias(String alias) {
    return WalletConfigs(attachedDatabase, alias);
  }
}
