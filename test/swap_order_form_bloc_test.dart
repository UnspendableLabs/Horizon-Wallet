...
List<TestCase> generateTestCases() {
  return [
        ...
        expectedOrders: [
          ...
          SimulatedOrderCreate(
              give: AssetQuantity(
                  ...
                  quantity: BigInt.from(50 * TenToTheEigth.value)),
              get: AssetQuantity(
                  divisible: true, quantity: BigInt.from(3333333300)))
        ]),
    //
    TestCase(
        description:
    ...
    TestCase(
      ...
      expectedOrders: [
        ...
        SimulatedOrderCreate(
            ...
            get: AssetQuantity(
                divisible: true,
                // TODO: fix rounding error that is happenign somewhere
                quantity: BigInt.from(66.66666650 * TenToTheEigth.value)))
      ],
    ),
    TestCase(
      description:
    ...
    TestCase(
      description:
          "AmountType.give-PriceType.give match-many giveDiv=false getDiv=false",
      priceType: PriceType.give,
      amountType: AmountType.give,
      giveDivisible: false,
      getDivisible: false,
          ...
          SimulatedOrderCreate(
              ...
              get: AssetQuantity(
                  ...
                  quantity: BigInt.from(
                      7500000075))), // TODO: fix small rounding error
        ]),
    TestCase(
        description:
        ...
        expectedOrders: [
          ...
          SimulatedOrderCreate(
              ...
              get: AssetQuantity(
                  divisible: true,
                  quantity: BigInt.from(
                      3750000009))), // TODO: fix small rounding error
        ]),
        ...
        expectedOrders: [
          ...
          SimulatedOrderCreate(
              ...
              get: AssetQuantity(
                  divisible: true,
                  quantity:
                      BigInt.from(7500000075 // TODO: fix small rounding error
                          )))
        ]),
    TestCase(
        description:
    ...
    TestCase(
        ...
        expectedOrders: [
          ...
          SimulatedOrderCreate(
              ...
              get: AssetQuantity(
                  divisible: true,
                  quantity: BigInt.from(3750000009))), // TODO: fix small rounding error
        ]),
    // TestCase(
    //     description:
