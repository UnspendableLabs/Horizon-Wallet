...
void main() {
  ...
  blocTest<OpenOrderFormBloc, FormStateModel>(
    ...
    act: (bloc) => bloc.add(const LockRatioChanged(true)),
    expect: () => [
      isA<FormStateModel>()
  ...
  blocTest<OpenOrderFormBloc, FormStateModel>(
    ...
    seed: () => FormStateModel(
      ...
      getQuantity: const GetQuantityInput.dirty("invalid", isDivisible: true),
      giveAssetValidationStatus: Success(FakeAsset(
        asset: 'ASSET1',
        owner: 'owner_address',
        divisible: false,
  ...
  blocTest<OpenOrderFormBloc, FormStateModel>(
    ...
    act: (bloc) => bloc.add(const GiveQuantityChanged("20")),
    expect: () => [
      isA<FormStateModel>()
  ...
  blocTest<OpenOrderFormBloc, FormStateModel>(
    ...
    act: (bloc) => bloc.add(const GetQuantityChanged("3000000000")),
    expect: () => [
      isA<FormStateModel>()
  ...
  blocTest<OpenOrderFormBloc, FormStateModel>(
    ...
    act: (bloc) => bloc.add(const GiveAssetChanged("ASSET")),
    expect: () => [
      isA<FormStateModel>()
          .having((s) => s.lockRatio, 'lockRatio', false)
          .having((s) => s.ratio, 'ratio', const Option.none())
  ...
  blocTest<OpenOrderFormBloc, FormStateModel>(
    ...
    act: (bloc) => bloc.add(const GetAssetChanged("ASSET")),
    expect: () => [
      isA<FormStateModel>()
          .having((s) => s.lockRatio, 'lockRatio', false)
          .having((s) => s.ratio, 'ratio', const Option.none())
