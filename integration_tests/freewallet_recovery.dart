...
import 'package:integration_test/integration_test.dart' as i;
...
late GetIt sl;
void main() async {
  i.IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  // compatibility with freewallet verified by addresses/priv keys generated in freewallet
  f.testWidgets('bip39 + bip32 recovery', (tester) async {
    ...
    for (var recoveredNode in recoveredNodes) {
      ...
      print((recoveredNode.address, expectedAdress));
      expect(recoveredNode.address, expectedAdress);
      print((recoveredNode.privateKey, expectedPrivateKey));
      expect(recoveredNode.privateKey, expectedPrivateKey);
      print((recoveredNode.index, expectedIndex));
